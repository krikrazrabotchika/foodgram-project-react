# Проект Foodgram
![example workflow](https://github.com/krikrazrabotchika/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)  
...
рецептов.
## Данные от входа для пользователя:
Логин: admin@mail.ru
Пароль: admin
